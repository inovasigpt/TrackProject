...
const ResetPasswordPage = ({ email, onSubmit, onBack }) => {
        ...
        return (
            <div className="min-h-screen w-full flex items-center justify-center bg-[#020617] font-display p-8">
                <div className="w-full max-w-md text-center animate-in fade-in zoom-in-95">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-3">Password Berhasil Diubah!</h2>
            ...
            <div className="w-full max-w-md">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 font-medium">
                        ...
                        <span className="text-[#26b9f7]"> {email}</span>
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-[#26b9f7] hover:bg-[#26b9f7]/90 disabled:opacity-50 disabled:cursor-not-allowed text-[#020617] font-bold py-4 rounded-xl shadow-lg shadow-[#26b9f7]/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2"
                    >
                        {isLoading ? (
                            <>
