...
// Default values for statuses and priorities
...
const FilterModal = ({ isOpen, onClose, projects, currentFilters, onApply }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            setAvailableStatuses(savedStatuses ? JSON.parse(savedStatuses) : DEFAULT_STATUSES);
            setAvailablePriorities(savedPriorities ? JSON.parse(savedPriorities) : DEFAULT_PRIORITIES);
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {uniquePics.length > 0 ? uniquePics.map(pic => (
                                <button
                                    key={pic}
