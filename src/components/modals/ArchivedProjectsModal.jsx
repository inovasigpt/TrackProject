...
import { X, Archive, ArchiveRestore, Trash2, Database, Folder, Box, Cpu, Globe, Server, Shield, Zap, Cloud, Code, ChevronLeft } from 'lucide-react';
...
const ArchivedProjectsModal = ({ isOpen, onClose, archivedProjects, onUnarchive, onDeletePermanently }) => {
    ...
    if (selectedProject) {
        const ProjectIcon = ICON_MAP[selectedProject.icon] || Database;
