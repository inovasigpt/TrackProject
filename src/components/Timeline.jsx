...
const calculatePhaseRows = (phases) => {
    ...
    const phaseRows = {};
    const rowEndDates = []; // Track the end date of each row
...
const Timeline = ({ projects, onPhaseClick }) => {
    ...
    const getProjectRowHeight = (projectId) => {
                                ...
                                {project.phases.map((phase) => {
                                    ...
                                    return (
                                        <PhaseBar
                                            ...
                                            onClick={(p, info) => onPhaseClick({ project, phase: p, info })}
                                        />
                                    );
                                })}
                            </div>
